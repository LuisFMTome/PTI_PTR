...
session_start(); 
    ...
    $Queryprodutos = "SELECT * FROM [dbo].[Produto] WHERE subtipo = '44' ORDER BY nome OFFSET " . $produtoInicial . " ROWS FETCH NEXT " . $produtosPágina . " ROWS ONLY";
    ...
    $QueryTotalProdutos = "SELECT * FROM [dbo].[Produto] WHERE subtipo = '44'";
